...
The purpose of these scenarios was to practice both the technical and procedural sides of IT support. Each ticket required investigating the user's issue, identifying the cause, implementing an appropriate solution, verifying the result, documenting the work performed, and closing the ticket.
...
Three support scenarios were completed:

### Ticket #1 - Sarah Johnson: Account Lockout

**Department:** Accounting  
**Ticket Type:** Incident  
**Issue:** User unable to sign into her Windows domain account after multiple unsuccessful login attempts.
...
**Department:** Accounting  
**Ticket Type:** Incident  
**Issue:** User can sign into the domain but receives an access denied message when attempting to access the Accounting shared folder.
